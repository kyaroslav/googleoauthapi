...
require_once dirname(__FILE__) . '/../service/apiServiceResource.php';
require_once dirname(__FILE__) . '/../service/apiServiceRequest.php';
require_once dirname(__FILE__) . '/../service/apiBatch.php';
